(function ($) {
  ...
  // Date Picker
  if ($(".hyperfly-datepicker").length) {
    $(".hyperfly-datepicker").datepicker();
  }
  ...
  if ($(".main-header--five__toggler, .sidebar-one__overlay, .sidebar-one__close").length) {
   ...
   // Sidebar Popup
  if ($(".main-header__toggler").length) {
    $(".main-header__toggler").on("click", function (e) {
      e.preventDefault();
  ...
  if ($("sidebar-one").length) {
    $("sidebar-one").on("click", function (e) {
      e.preventDefault();
  ...
  //accrodion
  if ($(".hyperfly-accrodion").length) {
    var accrodionGrp = $(".hyperfly-accrodion");
        ...
        $(this)
          ...
          .on("click", function () {
            if ($(this).parent().hasClass("active") === false) {
              $(".hyperfly-accrodion." + accrodionName)
                .find(".accrodion")
                .removeClass("active");
              $(".hyperfly-accrodion." + accrodionName)
                .find(".accrodion")
  ...
  function handleQtyChange(val, box) {
    console.log("Qty:", val);
    console.log("Parent tab:", box);
  }

  $(".add").on("click", function () {
    let box = $(this).closest(".tabs-box"); // 👈 parent tab
    let input = $(this).siblings("input");  // 👈 safer than prev()
    let value = +input.val();
    ...
    handleQtyChange(value, box); // 👈 send to function
  });

  $(".sub").on("click", function () {
    let box = $(this).closest(".tabs-box");
  ...
  function thmOwlInit() {
    // owl slider
    let hyperflyowlCarousel = $(".hyperfly-owl__carousel");
    ...
    let hyperflyowlCarouselNav = $(".hyperfly-owl__carousel--custom-nav");
    ...
    let hyperflyowlCarouselWithCounter = $(".hyperfly-owl__carousel--with-counter");
    if (hyperflyowlCarouselWithCounter.length) {
      hyperflyowlCarouselWithCounter.each(function () {
        let elm = $(this);
        let options = elm.data("owl-options");
        ...
        elm
          .on("initialized.owl.carousel", function (event) {
            ...
            elm.append(
              '<div class="hyperfly-owl__carousel__counter"><span class="hyperfly-owl__carousel__counter__current"></span> <span class="hyperfly-owl__carousel__counter__total"></span></div>'
            );
            elm
              .find(".hyperfly-owl__carousel__counter__current")
              .text(carousel.relative(carousel.current()) + 1);
            elm
              .find(".hyperfly-owl__carousel__counter__total")
              .text(carouselCount);
          })
          .owlCarousel(
            "object" === typeof options ? options : JSON.parse(options)
  ...
  function hyperflySlickInit() {
    // slick slider
    let hyperflyslickCarousel = $(".hyperfly-slick__carousel");
    ...
    let hyperflyslickCarouselCounter = $(".hyperfly-slick__custome-counter");
    if (hyperflyslickCarouselCounter.length) {
      hyperflyslickCarouselCounter.each(function () {
        ...
        let updateSliderCounter = function (slick, currentIndex) {
          ...
          $(sliderCounter).html(
            '<span class="hyperfly-slick__counter__active">' +
              currentSlide +
              "</span>" +
              "" +
              "<span>" +
  ...
  $(".hyperfly-owl__carousel").on("initialized.owl.carousel", function () {
    console.log("Carousel initialized with thumbnail dots");
  });
  /*-- Hover Tilt --*/
  let hyperflyTiltElm = $(".hyperfly-tilt");
  if (hyperflyTiltElm.length) {
    hyperflyTiltElm.each(function () {
      let self = $(this);
      let options = self.data("tilt-options");
      let hyperflyTilt = self.tilt(
        "object" === typeof options ? options : JSON.parse(options)
      );
    });
  }
  ...
  function hyperfly_stretch() {
    var i = $(window).width();
    $(".row .hyperfly-stretch-element-inside-column").each(function () {
      var $this = $(this),
  ...
  function hyperfly_cuved_circle() {
  ...
  $(document).ready(function () {
    $(
      ".case-study-four__wrapper .case-study-four__item, .portfolio-one__wrapper .portfolio-one__item"
